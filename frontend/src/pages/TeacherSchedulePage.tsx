...
export function TeacherSchedulePage() {
  ...
  return (
    <section className="page-stack">
      <div className="page-heading"><p className="eyebrow">Teaching scope</p><h1>My classes and timetable</h1><p>These records are restricted by the server to your active teaching assignments.</p></div>
