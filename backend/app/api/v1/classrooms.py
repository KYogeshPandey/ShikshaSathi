...
@bp.route("/<classroom_id>", methods=["PUT", "PATCH"])
@jwt_required()
@requires_roles("admin")
...
@bp.route("/<classroom_id>/students", methods=["GET"])
@jwt_required()
@requires_roles("admin")
...
@bp.route("/<classroom_id>/students/assign", methods=["POST"])
@jwt_required()
@requires_roles("admin")
...
@bp.route("/<classroom_id>/students/unassign", methods=["POST"])
@jwt_required()
@requires_roles("admin")
