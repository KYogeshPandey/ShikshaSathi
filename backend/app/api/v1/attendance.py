...
def get_daily_attendance():
    """
    Get daily attendance records for a classroom/date.
    Query params: classroom_id, date
    """
    try:
        classroom_id = request.args.get("classroom_id")
        ...
        if not classroom_id or not date:
            return jsonify({"success": False, "message": "classroom_id and date required"}), 400
